...
mydb = mysql.connector.connect(
    host="hostname",  # Or the IP address of your MySQL server
    user="root",
    password="password",
    database="login_page" # Optional: Specify a database to connect to directly
)
...
def login_varify():
    ...
    cursor.execute(sql, (user_varify, pas_varify))   # ✅ tuple
